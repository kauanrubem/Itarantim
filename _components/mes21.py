...
def criar_graficos_mes21(file_path, meses_selecionados):
    # --- Aba Receitas ---
    ...
    categorias_exatas = {
        ...
        "DESPESA LÍQUIDA COM PESSOAL": "Despesa Líquida",
    ...
    cards_extra_1 = [
        ...
        criar_totalizador_card_texto("Receita de Transferências Constitucionais e Legais", valores.get("Receita de Transferências Constitucionais e Legais", 0)),
    ...
    return html.Div([
        html.H4("RECEITAS 2021", style={"color": "black", "margin": "20px 0"}),
